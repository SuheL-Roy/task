            ...
            <div class="container mx-auto p-6">
                @foreach ($shop_page as $store)
                    <div class="bg-gray-100 p-4 rounded-lg shadow-md mb-8">
                        <h1 class="text-2xl font-bold font-semibold text-blue-600">{{ $store->first()->stores_name }}</h1> 
                        
                        @foreach ($store->groupBy('category_id') as $category)
                            <div class="bg-white p-3 rounded-lg shadow-sm mt-4">
                                <h2 class="text-xl font-semibold text-gray-800">{{ $category->first()->categories_name }}</h2> 
                                
                                <ul class="list-disc ml-6 mt-2">
                                    @foreach ($category as $product)
                                        <li class="text-gray-700">{{ $product->products_name }}</li> 
                                    @endforeach
                                </ul>
                            </div>
                        @endforeach
